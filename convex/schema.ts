...
export default defineSchema({
  ...
  emailConnections: defineTable({
    ...
    scanState: v.optional(v.union(
      ...
      v.literal("processing_batch_36"),
      v.literal("processing_batch_37"),
      v.literal("processing_batch_38"),
      v.literal("processing_batch_39"),
      v.literal("processing_batch_40"),
      v.literal("processing_batch_41"),
      v.literal("processing_batch_42"),
      v.literal("processing_batch_43"),
      v.literal("processing_batch_44"),
      v.literal("processing_batch_45"),
      v.literal("processing_batch_46"),
      v.literal("processing_batch_47"),
      v.literal("processing_batch_48"),
      v.literal("processing_batch_49"),
      v.literal("processing_batch_50"),
      v.literal("complete"),
      v.literal("error")
    )),
