...
export const createSubscription = mutation({
  args: {
    ...
    cost: v.number(),
    currency: v.string(),
    billingCycle: v.union(v.literal("daily"), v.literal("weekly"), v.literal("monthly"), v.literal("yearly")),
...
export const getUserSubscriptions = query({
  args: { 
    ...
    category: v.optional(v.string()),
    billingCycle: v.optional(v.union(v.literal("daily"), v.literal("weekly"), v.literal("monthly"), v.literal("yearly"))),
    // Multi-select support
    billing: v.optional(v.array(v.union(v.literal("daily"), v.literal("weekly"), v.literal("monthly"), v.literal("yearly")))),
