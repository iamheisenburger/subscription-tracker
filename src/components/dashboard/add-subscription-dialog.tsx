...
const formSchema = z.object({
  ...
  billingCycle: z.enum(["monthly", "yearly", "weekly"]).refine((val) => val, {
...
export function AddSubscriptionDialog({ trigger }: AddSubscriptionDialogProps) {
  ...
  const onSubmit = async (values: FormValues) => {
    ...
    try {
      ...
      if (errorMessage.includes("Subscription limit reached")) {
        toast.error("Subscription limit reached! Upgrade to Premium for unlimited subscriptions.", {
          action: {
            label: "Upgrade",
            onClick: () => {
