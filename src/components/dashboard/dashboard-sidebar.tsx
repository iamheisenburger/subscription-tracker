...
export function DashboardSidebar() {
  ...
  return (
    <div className="flex h-screen w-64 flex-col border-r bg-card">
      ...
      {/* Upgrade CTA */}
      <div className="p-4">
        <div className="rounded-lg border border-yellow-200 bg-yellow-50 dark:border-yellow-800 dark:bg-yellow-900/20 p-4 text-center">
          <Crown className="h-6 w-6 text-yellow-600 dark:text-yellow-400 mx-auto mb-2" />
          <h3 className="text-sm font-medium text-yellow-800 dark:text-yellow-200 font-sans">
            {isPremium ? "Premium Active" : "Upgrade to Premium"}
          </h3>
          <p className="text-xs text-yellow-600 dark:text-yellow-300 font-sans mt-1">
          ...
          {!isPremium && (
            <Link href="/pricing">
              <Button
                size="sm"
                className="mt-3 w-full bg-yellow-600 hover:bg-yellow-700 text-white font-sans"
              >
                Upgrade Now
              </Button>
            </Link>
